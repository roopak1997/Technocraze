...
const cred = {
  ...
  trial:"Athena",
  trialid:"JnJ101",
  about:"Enhancement to Drug AD1009",
  date:'May 2019'
};
var drugReports = [
...
router.get('/changephaseapi', function(req, res, next) {
    let command = "docker exec cli peer chaincode invoke -o orderer.example.com:7050 --tls true --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem -C athena -n mycc --peerAddresses peer0.org1.example.com:7051 --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt --peerAddresses peer0.org2.example.com:9051 --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt -c '{\"Args\":[\"setphase\",\"phase2\"]}'";
    console.log(command)
    cmd.get(
        command,
...
router.get('/trackdrug.ejs', function(req, res, next) {
  ...
  //  let command = '2019-05-09 21:16:34.109 UTC [chaincodeCmd] chaincodeInvokeOrQuery -> INFO 001 Chaincode invoke successful. result: status:200 message:"History is " payload:"[SHIPPER,DRUG666,BAT777,20,09/05/2019,11/05/2019,f9c52e895234e3cd4938bd2013a8a55aa9465682ce8bff6c3409f404826222a6,2019-05-09T21:14:59.229320564Z,file.as,asdddddddddddddddddddddddddddddddddddaasdasdasdasdasd, TRADER,DRUG777,BAT777,20,09/05/2019,11/05/2019,9a5c12aa96e971777c3ec4bdc2809168aa1c8dd0fb91e33a5debf8876d9e25e3,2019-05-09T21:16:00.260027659Z, SHIPPER,DRUG777,BAT777,20,09/05/2019,11/05/2019,4fc5e7c7db1416a09a16ffdd248c59d71c1fca155bfa78f3d98f3f56147f26d9,2019-05-09T21:16:30.704172508Z, TRADER,DRUG777,BAT777,20,09/05/2019,11/05/2019,9a5c12aa96e971777c3ec4bdc2809168aa1c8dd0fb91e33a5debf8876d9e25e3,2019-05-09T21:16:00.260027659Z, SHIPPER,DRUG777,BAT777,20,09/05/2019,11/05/2019,4fc5e7c7db1416a09a16ffdd248c59d71c1fca155bfa78f3d98f3f56147f26d9,2019-05-09T21:16:30.704172508Z]"'
    console.log(command)
  cmd.get(
      command,
      function(err, data, stderr) {
